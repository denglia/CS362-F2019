...
int do_mine(struct gameState* state, int currentPlayer, int nextPlayer, int choice1, int choice2, int handPos) { //state,currentPlayer,choice1,choice2, handPos
...
int do_baron(struct gameState* state, int currentPlayer, int nextPlayer, int choice1, int choice2, int handPos) { //state,currentPlayer,choice1,choice2, handPos
		...
		while (card_not_discarded) {
			if (state->hand[currentPlayer][p] == estate) { //Found an estate card!
				...
				if (supplyCount(estate, state) > 0) {
					gainCard(baron, state, 0, currentPlayer);
...
int do_ambassador(struct gameState* state, int currentPlayer, int nextPlayer, int choice1, int choice2, int handPos) {//state,currentPlayer,choice1,choice2, handPos
...
int do_minion(struct gameState* state, int currentPlayer, int nextPlayer, int choice1, int choice2, int handPos) {//state,currentPlayer,choice1,choice2, handPos
	//+1 action
	state->numActions++;
...
int do_tribute(struct gameState* state, int currentPlayer, int nextPlayer, int choice1, int choice2, int handPos) {//state, currentPlayer, nextPlayer, choice1, choice2, handPos
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case gardens:
        return -1;
		///state, currentPlayer, nextPlayer, choice1, choice2, handPos
    case mine:
		return do_mine(state, currentPlayer, nextPlayer, choice1, choice2, handPos);
    ...
    case baron:
		return do_baron(state, currentPlayer, nextPlayer, choice1, choice2, handPos);
    ...
    case minion:
		return do_minion(state, currentPlayer, nextPlayer, choice1, choice2, handPos);
    ...
    case tribute:
		return do_tribute(state, currentPlayer, nextPlayer, choice1, choice2, handPos);

    case ambassador:
		return do_ambassador(state, currentPlayer, nextPlayer, choice1, choice2, handPos);
